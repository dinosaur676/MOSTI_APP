...
class CommentsBloc extends ChangeNotifier{
  ...
  // Future reportComment (String collectionName, String? postDocumentName, String? uid, String? commnetTimestamp) async{
  //   final SharedPreferences sp = await SharedPreferences.getInstance();
  //   final String? _reporterUId = sp.getString('uid');
  //   final String _documentName = collectionName == 'places' ? 'place_reports' : 'blog_reports';
