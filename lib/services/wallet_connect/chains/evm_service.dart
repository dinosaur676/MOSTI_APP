...
class EVMService extends IChain {
  ...
  Future personalSign(String topic, dynamic parameters) async {
    ...
    try {
      final Credentials credentials = EthPrivateKey.fromHex(_getPrivateKey());
  ...
  String _getPrivateKey() {
    return GetIt.instance.get<AddressManager>().getSelectedAddress()!.getAddressToString()[Address.PRIVATE_KEY];
  }
}
