...
class _HeaderState extends State<Header> {
  ...
  void onTap() async {
    Map param = {};
    param["userName"] = "testnew@emblock.co.kr";
    param["email"] = "testnew@emblock.co.kr";
    param["lastName"] = "testnew";
    param["firstName"] = "testnew";
    param["password"] = "1";


    Map updateParam = {};
    param["userName"] = "test1234@emblock.co.kr";
    param["email"] = "test1234@emblock.co.kr";
    param["lastName"] = "test1234";
    param["firstName"] = "test1234";

    //print(await GetIt.instance.get<APIManager>().POST("/api/user", updateParam));
    //print(await GetIt.instance.get<APIManager>().PUT("/api/user", param));
    //print(await GetIt.instance.get<APIManager>().DELETE("/api/user"));
